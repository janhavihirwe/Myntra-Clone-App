import { Box, Button, Checkbox, CheckboxGroup, Divider, Grid, GridItem, HStack, Image, Select, Stack, Text, VStack } from '@chakra-ui/react';
      ...
      <Box>
        ...
        <Box padding="4">
          <Grid templateColumns="1fr 3fr" gap={6}>
            <Box>
              <Text fontWeight="bold" fontSize='4xl' mb={4} color='#ee64a6'>Kids: {filteredProducts.length}</Text>
